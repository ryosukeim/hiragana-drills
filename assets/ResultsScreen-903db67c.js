import{i as n}from"./index-0daa4ca9.js";class o{constructor(e,t,s,i,r,a){this.router=e,this.result=t,this.xpEarned=s,this.leveledUp=i,this.newLevel=r,this.practiceScreen=a}render(){const e=document.createElement("div");e.className="screen p-xl flex-col items-center justify-center",e.style.minHeight="100vh",this.result.score>=70&&this.createConfetti();const t=document.createElement("div");t.className="card card-gradient p-xl text-center animate-slide-up",t.style.maxWidth="500px";const s=this.getEmojiForScore(this.result.score),i=this.getTitleKeyForScore(this.result.score);if(t.innerHTML=`
